...
(function (e) {
    function z(l, m) {
        ...
        if (k.length > m) {
            for (var n = 0; n < m; ++n)
                s += k[n] + " ";
            return s + "<span style='font-size: 12px;color: #97B250;'> read more</span>"
        }
        else
            return l
    }
...
, 800)
                ...
                if (!r) {
                    var d = b.find(".fn-newsPreview").index(this); if (a.useLinks && a.feed) window.open(A[d], a.targetWindow);
                        ...
                        var f = x[d] + "</br><a href='" + link[d] + "'><span style='font-size: 12px;color: #97B250;cursor: pointer;'> See full page.</span></a>"; B(); b.find("#fn-newsView").css({ visibility: "visible", opacity: 0 }).stop().fadeTo(340, 1);
        ...
        return this.each(function () {
            ...
            if (a.feed) m();
                ...
                for (var f = [], c = 0; c < d.length; ++c) {
                    ...
                    x[c] = e(d[c]).children("span").html();
                    var j = e(d[c]).children("img").attr("src");
