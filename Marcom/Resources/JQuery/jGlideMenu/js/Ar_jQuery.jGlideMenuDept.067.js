...
jQuery.jGlideMenuDept = {
    ...
    loadTile: function (u, p) {
        ...
        if (jQuery.jGlideMenuDept.tileCount > 1) {
            // Insert Back Button
            jQuery('#' + ptr.id).append('<div class="jGMDept_back"><a href="#">رجوع</a></div>');
            ...
            if (jQuery.jGlideMenuDept.tileCount > 2) {
                // Insert Reset Button
                jQuery('#' + ptr.id).append('<div class="jGMDept_reset"><a href="#">الرئيسية</a></div>');
    ...
    scrollToTile: function (n, s) {
        ...
        jQuery('div#jGMDept_wrapper_' + jQuery.jGlideMenuDept.currentElementID).animate({ 'right': a }, s, jQuery.jGlideMenuDept.easeFx, function () {
            // Remove Extra Tiles
            if (n < t)
    ...
    buildTile: function (t, d, l) {
        ...
        // Scroll Up
        template += '<div class="jGMDept_pager"><a href="#" rel="Up" title="Scroll Up" style="display:none"><span>المزيد</span></a></div>';
        // Items
        ...
        template += '</div>';
        // Scroll Down
        template += '<div class="jGMDept_pager"><a href="#" rel="Down" title="Scroll Down" style="display:none"><span>المزيد</span></a></div>';
        return template;
    },
