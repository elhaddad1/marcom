...
jQuery.jGlideMenuBrand = {
    ...
    loadTile: function (u, p) {
        ...
        if (jQuery.jGlideMenuBrand.tileCount > 1) {
            // Insert Back Button
            jQuery('#' + ptr.id).append('<div class="jGMBrand_back"><a href="#">&laquo; Back</a></div>');
            ...
            if (jQuery.jGlideMenuBrand.tileCount > 2) {
                // Insert Reset Button
                jQuery('#' + ptr.id).append('<div class="jGMBrand_reset"><a href="#">&laquo; Home</a></div>');
    ...
    scrollToTile: function (n, s) {
        ...
        jQuery('div#jGMBrand_wrapper_' + jQuery.jGlideMenuBrand.currentElementID).animate({ 'left': a }, s, jQuery.jGlideMenuBrand.easeFx, function () {
            // Remove Extra Tiles
            if (n < t)
    ...
    buildTile: function (t, d, l) {
        ...
        // Scroll Up
        template += '<div class="jGMBrand_pager"><a href="#" rel="Up" title="Scroll Up" style="display:none"><span>More</span></a></div>';
        // Items
        ...
        template += '</div>';
        // Scroll Down
        template += '<div class="jGMBrand_pager"><a href="#" rel="Down" title="Scroll Down" style="display:none"><span>More</span></a></div>';
        return template;
    },
    // Error Function
