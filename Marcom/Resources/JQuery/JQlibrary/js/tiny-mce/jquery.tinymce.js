(function(b) 
{
    ...
    b.fn.tinymce = function (j) {
        ...
        if (!c.tinymce && !d && (g = j.script_url)) {
            ...
            } b.ajax({ type: "GET", url: g, dataType: "script", cache: true, success: function () { tinymce.dom.Event.domLoaded = 1; d = 2; if (j.script_loaded) { j.script_loaded() } o(); b.each(a, function (q, r) { r() }) } })
    ...
    function f() {
        function i(l) {
            ...
            var m = this, l; if (n !== e) {
                ...
                if (m.length > 0) { 
           if (l = tinyMCE.get(m[0].id)) { return l.getContent() } } } } function h(m) {
            var l = null;
        ...
        b.each(["append", "prepend"], function (n, m) {
            ...
            b.fn[m] = function (q) {
                ...
                if (q !== e) {
                    p.filter(":tinymce").each(function (s, t) { var r = h(t); r && r.setContent(l ? q + r.getContent() : r.getContent() + q) });
                    o.apply(p.not(":tinymce"), arguments);
                    return p
                } 
            } 
        ...
        b.each(["remove", "replaceWith", "replaceAll", "empty"], function (m, l) {
            var n = j[l] = b.fn[l]; b.fn[l] = function () {
                i.call(this, l);
        ...
        b.fn.attr = function (n, q, o) {
            var m = this; if ((!n) || (n !== "value") || (!g(m))) { return j.attr.call(m, n, q, o) }
            if (q !== e) {
                ...
                var p = m[0], l = h(p); return l ? l.getContent() : j.attr.call(b(p), n, q, o)
            } 
        } 
    } 
})
