...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <%-------------------Css-------------%>
    <!--[if IE 7]>
    <link href="<%=Page.ResolveClientUrl("~/Resources/Styles/Home/ieHome_Style.css")%>"
    ...
    <![endif]-->
    <!--[if !IE]> -->
    <link href="<%=Page.ResolveClientUrl("~/Resources/Styles/Home/Home_Style.css")%>"
        rel="stylesheet" type="text/css" />
    <!-- <![endif]-->
    <link href="<%=Page.ResolveClientUrl("~/Resources/JQuery/Slider/SlideShow1.2/css/rhinoslider-1.05.css")%>"
        rel="stylesheet" type="text/css" />
    <link href="<%=Page.ResolveClientUrl("~/Resources/JQuery/fancynews/css/jquery.fancyNews-1.2.css")%>"
        rel="stylesheet" type="text/css" />
    ...
    <script async type="text/javascript" src="<%=Page.ResolveClientUrl("~/Resources/JQuery/fancynews/js/jquery.fancyNews.min.js")%>"></script>
    ...
    <!-- FancyNews plugin -->
    <script async src="<%=Page.ResolveClientUrl("~/Js/Home/HomeInitiat.min.js")%>" type="text/javascript"></script>
</asp:Content>
                    ...
                    <tr>
                        <td class="HomeTable_td1">
                            <div class="HomeTable_td1_div">
                                <div class="HomeHeaders_div">
                                    <%--    <span class="Home-Headers">Most Visited </span>--%>
                                </div>
                                <div class="Offers_div" align="center">
                                    <ul id="TopProducts">
                                        <%=Html.Action("PrtialTopOffer", "Home")%>
                                    </ul>
                                </div>
                            </div>
                        </td>
                        <td class="HomeTable_td2">
                            <div class="HomeTable_td2_div">
                                <div class="HomeHeaders_div">
                                    <%--     <span class="Home-Headers">Promotions</span>--%>
                                </div>
                                <div class="Offers_div">
                                    <%=Html.Action("WeeklyOffers","Home")%>
                                </div>
                            </div>
                        </td>
