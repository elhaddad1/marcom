...
<table border="0" cellpadding="0" cellspacing="0" class="OneproductTable">
    <tr>
     <td class="ProductBrand">
                        <img style="top:5px; float:left;left:5px; max-width:125px;" src="<%=Marcom.Models.clsGlobel.SrcbrandsDomain+item.Products.Brands.Image_Path %>">
                    </td>
        <td class="ProductImg_td">
        <a href="<%=Url.Action("WeeklyOffer", "Home", new {id =item.id})%>" class="ProductTitle_link">
            ...
            <%--<img class="Product_img" src="<%=Marcom.Models.clsGlobel.SrcWeeklyOfferDomain+item.Image_Path %>" /></a>--%>
        </td>
    </tr>
    <tr>
        <td class="ProductTitle_td" colspan="2" style="width:auto;">
            <a href="<%=Url.Action("WeeklyOffer", "Home", new {id =item.id})%>" class="ProductTitle_link">
                <span class="ProductsTitle_span">
                    <%=item.Product_Title_Eng %></span></a>
        </td>
    </tr>
    <tr>
        <td class="ProductDescription_td" colspan="2" style="width:auto;">
           <span class="desc">
                <%=item.Products.Product_Short_Eng != null ? item.Products.Product_Short_Eng : item.Product_Title_Eng%>
       </span>
        </td>
    </tr>
    <tr>
