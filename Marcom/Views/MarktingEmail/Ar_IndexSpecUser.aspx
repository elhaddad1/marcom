                                    ...
                                    <tr>
                                        <td class="headerContent">
                                            ...
                                            <a href="http://marcomtrade.com">
                                                <img src="http://marcomtrade.com/Resources/Images/Portal/Logo.png" width="450" id="Img1"
                        ...
                        <tr>
                            <td align="center" valign="top" style="100%">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    <div mc:edit="std_content00" style="text-align: right;">
                                                                        <strong>عزيزى العميل,</strong><br />
                                                                        لقد تم أرسال هذا البريد الأكترونى لك بناء على رغبتك فى معرفة منتاجاتنا الجديدة التى
                                                                        تم عرضها على موقعنا الألكترونى .
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <div mc:edit="tiwc200_content02" style="text-align: center;">
                                                                <a href="http://marcomtrade.com<%=Url.Action("WeeklyOffer", "Home", new {id =obj.id})%>">
                                                                    <h4 class="h4" style="text-align: center;">
                                                                        <%=obj.Product_Title_Ar %>
                                                                    </h4>
                                                                    <%=obj.Products.Product_Short_Ar%>
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                    ...
                                    <%} %>
                                    <tr>
                                        <span style="float: right;"><strong>بعض المنتجات الأخرى التى قد تكون مهتم بها.</strong></span></tr>
                                    <tr>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="600">
                                                <tr>
                                                    ...
                                                    <td valign="top" width="280" class="leftMidColumnContent">
                                                        <!-- // Begin Module: Top Image with Content \\ -->
                                                        <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[0].Product_id ,name=Model.ToList()[0].Product_Title_Ar})%>">
                                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                <tr mc:repeatable>
                                                                    <td valign="top" style="text-align: center;">
                                                                        ...
                                                                        <div mc:edit="tiwc300_content00" style="text-align: center;">
                                                                            <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[0].Product_id ,name=Model.ToList()[0].Product_Title_Ar})%>">
                                                                                <h4 class="h4" style="text-align: center;">
                                                                                    <%= Model.ToList()[0].Product_Title_Ar%></h4>
                                                                                <%=Model.ToList()[0].Product_Short_Ar%>
                                                                            </a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <td valign="top" width="280" class="rightMidColumnContent">
                                                        <!-- // Begin Module: Top Image with Content \\ -->
                                                        <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[1].Product_id ,name=Model.ToList()[1].Product_Title_Ar})%>">
                                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                <tr mc:repeatable>
                                                                    <td valign="top" style="text-align: center;">
                                                                        <div style="max-height: 200px; max-width: 250px; text-align: center;">
                                                                        ...
                                                                        <div mc:edit="tiwc300_content01" style="text-align: center;">
                                                                            <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[1].Product_id ,name=Model.ToList()[1].Product_Title_Ar})%>">
                                                                                <h4 class="h4" style="text-align: center;">
                                                                                    <%= Model.ToList()[1].Product_Title_Ar%></h4>
                                                                                <%=Model.ToList()[1].Product_Short_Ar %>
                                                                            </a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                        ...
                                        <td valign="top" align="center">
                                            <table border="0" cellpadding="0" cellspacing="0" width="600">
                                                <tr>
                                                    ...
                                                    <td valign="top" width="280" class="leftMidColumnContent">
                                                        <!-- // Begin Module: Top Image with Content \\ -->
                                                        <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[3].Product_id ,name=Model.ToList()[3].Product_Title_Ar})%>">
                                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                <tr mc:repeatable>
                                                                    <td valign="top" style="text-align: center;">
                                                                        <div style="max-height: 200px; max-width: 250px; text-align: center;">
                                                                        ...
                                                                        <div mc:edit="tiwc300_content00" style="text-align: center;">
                                                                            <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[3].Product_id ,name=Model.ToList()[3].Product_Title_Ar})%>">
                                                                                <h4 class="h4" style="text-align: center;">
                                                                                    <%= Model.ToList()[3].Product_Title_Ar%></h4>
                                                                                <%=Model.ToList()[3].Product_Short_Ar %>
                                                                            </a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <td valign="top" width="280" class="rightMidColumnContent">
                                                        <!-- // Begin Module: Top Image with Content \\ -->
                                                        <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[2].Product_id ,name=Model.ToList()[2].Product_Title_Ar})%>">
                                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                <tr mc:repeatable>
                                                                    <td valign="top" style="text-align: center;">
                                                                        <div style="max-height: 200px; max-width: 250px; text-align: center;">
                                                                        ...
                                                                        <div mc:edit="tiwc300_content01" style="text-align: center;">
                                                                            <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[2].Product_id ,name=Model.ToList()[2].Product_Title_Ar})%>">
                                                                                <h4 class="h4" style="text-align: center;">
                                                                                    <%= Model.ToList()[2].Product_Title_Ar%></h4>
                                                                                <%=Model.ToList()[2].Product_Short_Ar%>
                                                                            </a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <td valign="top" width="100%" dir="rtl">
                                                        <div mc:edit="std_footer" style="text-align: right;">
                                                            <p style="margin: 10px auto; text-align: center; width: 500px; padding: 0 0 5px 0;">
                                                                إذا كنت لا ترغب فى أستلام هذه الرسائل برجاء الضغط على &nbsp;<a rel="nofollow" target="_blank"
                                                                    href="http://marcomtrade.com<%=Url.Action("ArUnsupscripeAccount", "clsWebService", new { urlpath = ViewData["UserDataId"] })%>">Unsubscribe</a></p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
