                                                            ...
                                                            <tr>
                                                                <td valign="top" align="right" dir="rtl">
                                                                    <div mc:edit="std_content00" style="text-align: right;">
                                                                        ...
                                                                        <br />
                                                                        <h2>
                                                                            نشكرك على اهتمامك باجهزتنا وخدماتنا</h2>
                                                                        <h3>
                                                                            اسم العميل:
                                                                            <%: Html.DisplayFor(model => model.UserNamer) %>
                                                                            <br />
                                                                            البريد الالكترونى:
                                                                            ...
                                                                            <br />
                                                                            <%} %>
                                                                            التليفون :<%: Html.DisplayFor(model => model.Telephonenumber) %>
                                                                            <br />
                                                                            تعليق العميل :<%: Html.DisplayFor(model => model.CustomerComment) %>
                                                                            <br />
                                                                        </h3>
                                                                        <h2>
                                                                            سيقوم احد ممثلى خدمة العملاء بالاتصال بك فى خلال فترة قصيرة. اذا لم يتم الاتصال
                                                                            بك فى خلال يومين عمل برجاء تحويل هذه الرسالة الى sales@marcomtrade.com</h2>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
