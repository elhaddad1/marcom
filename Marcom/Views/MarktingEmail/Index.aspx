                                                                        ...
                                                                        <div style="max-height: 200px; max-width: 250px; text-align: center;">
                                                                            <a href="http://marcomtrade.com<%=Url.Action("ProductDetail", "Products", new {id =Model.ToList()[0].Product_id ,name=Model.ToList()[0].Product_Title_Eng})%>">
                                                                                <img src="<%=Marcom.Models.clsGlobel.SrcProductDomain+Model.ToList()[0].Image_Path%>"
                                                                                    width="200" mc:label="image" mc:edit="tiwc300_image00" /></a>
                                                                        </div>
                                                ...
                                                <tr>
                                                    <td colspan="2" valign="middle" id="social">
                                                        <div mc:edit="std_social" style="text-align: center;">
                                                            &nbsp;<a href="https://twitter.com/Marcomtrade">follow on Twitter</a> | <a href="https://www.facebook.com/Marcom.Trade">friend on Facebook</a> | <a href="http://www.linkedin.com/company/marcom-trade">Follow
                                                                    on Linked in</a>&nbsp;
                                                        </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td valign="top" width="100%">
                                                        <div mc:edit="std_footer" style="text-align: left;">
                                                            <p style="margin: 10px auto; text-align: center; width: 500px; padding: 0 0 5px 0;">
                                                               ...
                                                               If you want to unsubscribe, click &nbsp;<a rel="nofollow" target="_blank" href="http://marcomtrade.com<%=Url.Action("UnsupscripeAccount", "clsWebService", new { urlpath = ViewData["UserDataId"] })%>">Unsubscribe</a>
                                                            </p>
                                                        </div>
                                                    </td>
                                                </tr>
