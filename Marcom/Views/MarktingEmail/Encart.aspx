                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    <div mc:edit="std_content00">
                                                                        <h1>
                                                                            Dear Marcom Trade Customer,</h1>
                                                                        <br />
                                                                        <h2>
                                                                            Thank You for showing interest in Marcom Trade’s Products</h2>
                                                                        <h3>
                                                                            User Namer : <%: Html.DisplayFor(model => model.UserNamer) %>
                                                                            <br />
                                                                            User Email : <%: Html.DisplayFor(model => model.UserEmail) %>
                                                                            <br />
                                                                            <%foreach (var itm in Model.card)
                                                                              { %>
                                                                            Product Title : <%=itm.ProductNamer %> , Quantity : <%=itm.Amount %>
                                                                            <br />
                                                                            <%} %>
                                                                            Telephone number : <%: Html.DisplayFor(model => model.Telephonenumber) %>
                                                                            <br />
                                                                            Customer Comment : <%: Html.DisplayFor(model => model.CustomerComment) %>
                                                                        
                                                                        <br />
                                                                        </h3>
                                                                        <h4>
                                                                            One of our customer support team will be in contact with you shortly, if within
                                                                            two working day you did not receive a reply please forward your email to sales@marcomtrade.com</h4>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
