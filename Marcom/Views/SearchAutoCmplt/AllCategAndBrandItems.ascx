...
<table class="MasterProductsTable" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td class="SiteMap">
                 <a href="<%=Url.Action("Home", "Ar_Home")%>" class="SiteMap_link"><span class="SiteMap_span">Home ></span></a> <a
        ...
        <tr>
            ...
            <%if (Model.Count() > 0)
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="OneproductTable">
                                            ...
                                            <tr>
                                                <td class="ProductTitle_td">
                                                    ...
                                                    <a href="<%=Url.Action("ProductDetail", "Ar_Products", new {id =item.Product_id ,name=item.Product_Title_Ar})%>" class="ProductTitle_link"><span class="ProductsTitle_span"><%=item.Product_Title_Eng%></span></a>
                                                </td>
                                            </tr>
                                            <tr>
              ...
              { %>
              <div style="width: 500px; height: 25px; background-color: #005984;color:White;">No Matching result for your word</div>
                 <%} %>
            </td>
        </tr>
        <tr>
            <td class="MasterProductsTable_td3">
                <%: Html.PagerAjax(Request.QueryString["Page"], 8, (int)ViewData["ListCount"], Url.Action("AllCategAndBrandItems", "Ar_SearchAutoCmplt", new { StrName = (string)ViewData["StrName"]}))%>
            </td>
        </tr>
    </table>
