...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        jQuery(function () {
			...
			.autocomplete({
			    ...
			    select: function (event, ui) {
			        var aquireStudentsURL = '/Ar_SearchAutoCmplt/AllCategAndBrandItems?StrName=' + ui.item.value + '';
    ...
    <div class="demo">
        <div style="width: 500px; height: 25px; background-color: #005984;">
            <span class="HeaderText_span">&nbsp;&nbsp; Search :&nbsp;&nbsp;</span>
    ...
    <%if (ViewData["Str"] != null)
      {  %>
    <script type="text/javascript">
        var aquireStudentsURL2 = '/Ar_SearchAutoCmplt/AllCategAndBrandItems?StrName=' + jQuery('#tags').val() + '';
